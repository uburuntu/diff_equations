              ...
              case 1:
                {
                  ...
                  g00 = (calc_type != SMOOTH && is_equal (xx, 0.0) ? RHO_G : G[m]);
                  mmv1R0 = mm + 4;
                  ...
                  switch (grid_type)
                    {
                      case SQUARE:
                        {
                          g00 = G[m];
                          v100 = (calc_type != SMOOTH ? V1[m - 1] : u1 (tt, xx, yy));
                          v200 = u2 (tt, xx, yy);
                          break;
                        }
                      ...
                      case NASTYA_11:
                        {
                          g00 = G[m];
                          v100 = (calc_type != SMOOTH && is_equal (xx, p_d->Segm_X) ? V1[m - 1] : u1 (tt, xx, yy));
                          v200 = u2 (tt, xx, yy);
                          break;
                        }
                    }
                      ...
                      case VOLODYA_9:
                        {
                          g00 = G[m];
                          v100 = u1 (tt, xx, yy);
                          v200 = (calc_type != SMOOTH && is_equal (yy, 0.) ? V2[M0R[m]] : u2 (tt, xx, yy));
                          break;
                        }
                    }
